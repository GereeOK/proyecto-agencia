...
import { sendConsulta } from "../firebase/firestore"; // Asegurate de que el path esté bien
...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus("Error al enviar la consulta ❌");
    }
  };
      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <form onSubmit={handleSubmit} className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            {status && (
              <div className="p-2 w-full text-center text-sm text-green-400">
                {status}
              </div>
            )}
          </div>
